...
class SImpleExoPlayerModule {
    ...
    @Provides
    @ServiceScoped
    fun provideForwardingPlayer(simpleExoPlayer: SimpleExoPlayer,
        ...
        return MyForwardingPlayer(simpleExoPlayer, audioBecomingNoisyBroadcastReceiver, playerNotificationManager)
    }
