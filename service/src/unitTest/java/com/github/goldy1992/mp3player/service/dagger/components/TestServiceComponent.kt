...
@Singleton
@Component(modules = [ContentManagerModule::class, ExoPlayerModule::class, MediaSessionConnectorModule::class, MediaSessionCompatModule::class, MockSearchDatabaseModule::class])
