  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col flex-grow items-center justify-between px-24 pt-10 pb-[10px]">
        <div className="flex-1 flex items-center text-center">An <span className="font-bold italic">open source</span> <span className="text-3xl font-extrabold text-nowrap">MP3 Player</span> for <span className="font-bold">Android</span></div>
