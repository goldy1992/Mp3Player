...
const DarkModeIcon : React.FC = ({width=48, height=48, fill="#212121"}: {width?:Number, height?:Number, fill?: string}) => {
    return (
         ...
         <svg width={width.toString()} height={height.toString()} viewBox="0 0 24 24" fill="green" version="1.1" xmlns="http://www.w3.org/2000/svg">
      <title>ic_fluent_dark_theme_24_regular</title>
    <desc>Created with Sketch.</desc>
    <g id="🔍-Product-Icons" stroke="none" stroke-width="1" fill={fill} fill-rule="evenodd">
        <g id="dark_mode" fill-rule="nonzero">
