...
class FolderActivityTest {
    ...
    private var scenario: ActivityController<FolderActivityInjectorTestImpl>? = null
    ...
    fun setup() {
        ...
        scenario = Robolectric.buildActivity(FolderActivityInjectorTestImpl::class.java, intent).setup()
    }
