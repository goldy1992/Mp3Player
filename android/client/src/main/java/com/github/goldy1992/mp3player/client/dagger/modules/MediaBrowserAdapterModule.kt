...
class MediaBrowserAdapterModule {
    ...
    fun provideMediaBrowserAdapter(mediaBrowser: MediaBrowserCompat,
                                   ...
                                   mySearchCallback: MySearchCallback,
                                    myConnectionCallback: MyConnectionCallback) : MediaBrowserAdapter {
        return MediaBrowserAdapter(mediaBrowser, mySubscriptionCallback, mySearchCallback, myConnectionCallback)
    }
}