...
constructor(context: Context) {
    ...
    init {
        ...
        CONNECTION_CHANNEL_NAME = CHANNEL_PREFIX + CHANNEL_NAME_MAP[CONNECTION]
        REQUEST_CHANNEL_NAME = CHANNEL_PREFIX +  CHANNEL_NAME_MAP[REQUEST]
        SUBSCRIPTION_CHANNEL_NAME = CHANNEL_PREFIX +  CHANNEL_NAME_MAP[SUBSCRIPTION]
