...
class MediaPlayerTrackViewHolderTest {
    ...
    @Before
    fun setup() {
        whenever<Any?>(view.findViewById(R.id.titleToolbar)).thenReturn(toolbar)
//        whenever<Any?>(view.songArtist).thenReturn(artistView)
    ...
    fun testBindMediaItem() {
        ...
        assertEquals( expectedTitle, toolbar.title)
        assertEquals(expectedArtist, toolbar.subtitle)
